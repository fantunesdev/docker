...
python manage.py migrate statement 0007_alter_transaction_description --fake
...
# Descomentar para forçar o container da aplicação a ficar em pé, mesmo que erros ocorram
# tail -f /dev/null